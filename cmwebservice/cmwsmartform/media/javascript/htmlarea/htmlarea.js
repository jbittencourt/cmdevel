...
//
// $Id: htmlarea.js,v 1.3 2006/11/29 18:41:23 cbasso Exp $
...
HTMLArea.Config = function () {
	...
	for (var i in this.btnList) {
		...
		btn[1] = _editor_url_images + this.imgURL + btn[1];
...
HTMLArea.prototype.generate = function () {
	...
	if (textarea.form) {
		...
		var f = textarea.form;
		//for(var q in textarea.form) { document.write(q+"------------"+textarea[q]+"<br>"); }
...
HTMLArea.prototype._insertImage = function(image) {
	...
	this._popupDialog("cminsert_image.html", function(param) {
...
HTMLArea.prototype.imgURL = function(file, plugin) {
	if (typeof plugin == "undefined")
		return _editor_url_images + file;
	else
		return _editor_url_images + "plugins/" + plugin + "/img/" + file;
};
